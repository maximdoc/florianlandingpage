...
function getIconSvg(name) {
  switch (name) {
    ...
    case 'modern-arrow-right':
      return `<path fill-rule="evenodd" d="M3.25 8a.75.75 0 01.75-.75h7.19L8.03 4.56a.75.75 0 011.06-1.06l4.5 4.25a.75.75 0 010 1.08l-4.5 4.25a.75.75 0 01-1.06-1.06l2.97-2.82H4a.75.75 0 01-.75-.75z" clip-rule="evenodd"/>`;
    
    case 'arrow-forward':
      return `<path d="M7.25 2.75a.75.75 0 0 0 0 1.5h5.19L2.22 14.47a.75.75 0 0 0 1.06 1.06L13.5 5.31v5.19a.75.75 0 0 0 1.5 0v-7a.75.75 0 0 0-.75-.75h-7z"/>`;
    ...
    // Add chat icon
    case 'chat':
      return `<path d="M8 15c4.418 0 8-3.134 8-7s-3.582-7-8-7-8 3.134-8 7c0 1.76.743 3.37 1.97 4.6-.097 1.016-.417 2.13-.771 2.966-.079.186.074.394.273.362 2.256-.37 3.597-.938 4.18-1.234A9.06 9.06 0 0 0 8 15z"/>`;
